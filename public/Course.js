...
function CreateCourseClassroom(txtName,txtDescription,txtDescriptionHeading,playListID) {
  ...
  return gapi.client.youtube.playlists.insert({
    ...
    "resource": {
      ...
      .then(function(response) {
              ...
              CreateCourseClassroom(txtName,txtDescription,txtDescriptionHeading,playlistID);
            },
